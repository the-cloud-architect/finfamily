...
function getCanonicalRedirectTo() {
  // Prefer an explicit canonical site URL (prevents redirecting to Vercel preview domains).
  // Example: VITE_SITE_URL=https://4cast.site
...
export default function Auth({ onAuthSuccess }) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      const redirectTo = getCanonicalRedirectTo();
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "#64748b", fontSize: "12px", margin: 0, letterSpacing: "2px" }}>
